...
const BATCH = path.join(ROOT, 'Governance/ch6-11-verification-batch.json');
...
const req = JSON.parse(fs.readFileSync(path.join(ROOT, 'Governance/requirements.json'), 'utf8'));
