...
const OUT = path.join(ROOT, 'Governance/CONSTITUTION_TRACEABILITY_MATRIX.md');
const requirements = JSON.parse(fs.readFileSync(path.join(ROOT, 'Governance/requirements.json'), 'utf8'));
const evidenceMap = JSON.parse(fs.readFileSync(path.join(ROOT, 'Governance/evidence.json'), 'utf8'));
