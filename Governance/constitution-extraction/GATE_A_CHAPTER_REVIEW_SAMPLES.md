...
Generated at 2026-06-27T15:51:16Z.
...
### Product/UX sample: `C5-5.1-002`
- Category: Product Enforceable Requirement
- Status: Governance Corrected
- Implementation target: Runtime Behavior
- Reason: Posting authority rule.
...
### Product/UX sample: `C12-12.2-002`
- Category: UX / Presentation Requirement
- Status: Governance Corrected
- Implementation target: UI / UX
- Reason: Optional fields presentation rule.
...
### Product/UX sample: `C16-16.2-002`
- Category: Product Enforceable Requirement
- Status: Governance Corrected
- Implementation target: Multiple
- Reason: Item images must not be created via transactional documents.

```text
must not be created or modified through transactional documents.
```
...
### Product/UX sample: `C19-19.2-002`
- Category: Product Enforceable Requirement
- Status: Governance Corrected
- Implementation target: Multiple
- Reason: No duplicate error channels.
...
### Product/UX sample: `C20-20.5-001`
- Category: Product Enforceable Requirement
- Status: Governance Corrected
- Implementation target: Runtime Behavior
- Reason: Must not notify for inaccessible documents.
...
### Product/UX sample: `C21-21.2-002`
- Category: Product Enforceable Requirement
- Status: Governance Corrected
- Implementation target: UI / UX
- Reason: Must not block entire application.
...
- Status: Governance Corrected
- Implementation target: Multiple
- Reason: Block 3 — §22.1 unified audit timestamp obligation.
...
### Product/UX sample: `C26-26.2-001`
- Category: Product Enforceable Requirement
- Status: Governance Approved
- Implementation target: Multiple
- Reason: §26 print/export authorization rule.

```text
Platform electronic record is authoritative
```
