...
const RESOURCES = Object.freeze([
  ...
  { code: 'LOST_FOUND',         name: 'Lost & Found Register',                       category: 'Operations',      displayOrder: 105 },
...
const PERMISSION_MAP = Object.freeze([
  ...
  { legacyCode: 'TRANSFER_DISPATCH_RECEIVE',     resource: 'TRANSFER',          action: 'DISPATCH_RECEIVE',     name: 'Dispatch / Receive Transfers (Deprecated SYS-DEC-07 — no active routes)' },
  ...
  { legacyCode: 'LOST_FOUND_VIEW',               resource: 'LOST_FOUND',        action: 'VIEW',                 name: 'View Lost & Found Register' },
  { legacyCode: 'LOST_FOUND_CREATE',             resource: 'LOST_FOUND',        action: 'CREATE',               name: 'Create Lost & Found Entry' },
  { legacyCode: 'LOST_FOUND_RETURN',             resource: 'LOST_FOUND',        action: 'RETURN',               name: 'Mark Lost & Found Returned' },
  ...
  { legacyCode: 'PERIOD_CLOSE_MANAGE',           resource: 'PERIOD_CLOSE',      action: 'MANAGE',               name: 'Manage Period Close (legacy bundle)' },
...
const AUTHORITY_ROLE_GRANTS = Object.freeze({
  ...
  LOST_FOUND_VIEW: { ORG_MANAGER: true, DEPT_MANAGER: true, FINANCE_MANAGER: true },
  LOST_FOUND_CREATE: { ORG_MANAGER: true, STOREKEEPER: true, DEPT_MANAGER: true },
  LOST_FOUND_RETURN: { ORG_MANAGER: true, DEPT_MANAGER: true, FINANCE_MANAGER: true, COST_CONTROL: true, GENERAL_MANAGER: true },
  ...
  ADJUSTMENT_CREATE: { FINANCE_MANAGER: true },
