...
const RESOURCES = Object.freeze([
  ...
  { code: 'REQUISITION',        name: 'Store Requisitions',                          category: 'Operations',      displayOrder: 45 },
...
const PERMISSION_MAP = Object.freeze([
  ...
  { legacyCode: 'ISSUE_VIEW',                    resource: 'ISSUE',             action: 'VIEW',                 name: 'View Store Issues' },
  ...
  { legacyCode: 'REQUISITION_VIEW',              resource: 'REQUISITION',       action: 'VIEW',                 name: 'View Requisitions' },
  { legacyCode: 'REQUISITION_CREATE',            resource: 'REQUISITION',       action: 'CREATE',               name: 'Create Requisitions' },
  { legacyCode: 'REQUISITION_SUBMIT',            resource: 'REQUISITION',       action: 'SUBMIT',               name: 'Submit Requisitions' },
  { legacyCode: 'REQUISITION_APPROVE',           resource: 'REQUISITION',       action: 'APPROVE',              name: 'Approve Requisitions' },
...
const AUTHORITY_ROLE_GRANTS = Object.freeze({
  ...
  ISSUE_VIEW: {
    STOREKEEPER: true, DEPT_MANAGER: true, COST_CONTROL: true, FINANCE_MANAGER: true,
    AUDITOR: true, ORG_MANAGER: true,
  },
  REQUISITION_VIEW: { STOREKEEPER: true, DEPT_MANAGER: true, ORG_MANAGER: true, FINANCE_MANAGER: true },
  REQUISITION_CREATE: { STOREKEEPER: true, DEPT_MANAGER: true, ORG_MANAGER: true },
  REQUISITION_SUBMIT: { STOREKEEPER: true, DEPT_MANAGER: true, ORG_MANAGER: true },
  REQUISITION_APPROVE: { DEPT_MANAGER: true, FINANCE_MANAGER: true, ORG_MANAGER: true },
