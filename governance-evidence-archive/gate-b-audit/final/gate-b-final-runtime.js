 ...
 * Output: Governance/gate-b-audit/final/GATE_B_RUNTIME_RESULTS.json
 */
...
const OUT = path.join(__dirname, '../../Governance/gate-b-audit/final/GATE_B_RUNTIME_RESULTS.json');
...
async function main() {
  ...
  const deptFixPath = path.join(__dirname, '../../Governance/closeout-runtime-audit/DEPT_STOCK_FIXTURES.json');
