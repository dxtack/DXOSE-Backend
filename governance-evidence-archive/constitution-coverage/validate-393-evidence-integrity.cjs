...
const MATRIX_PATH = path.join(ROOT, 'governance-evidence-archive/constitution-coverage/FULL_CONSTITUTION_COVERAGE_393_MATRIX_v2.json');
const V3_PATH = path.join(ROOT, 'governance-evidence-archive/runtime-revalidation/P0_RUNTIME_V3_FINAL.json');
const OUT_PATH = path.join(ROOT, 'governance-evidence-archive/constitution-coverage/EVIDENCE_INTEGRITY_VALIDATION.json');
