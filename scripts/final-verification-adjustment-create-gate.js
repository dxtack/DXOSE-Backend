...
const REPORT_DIR = path.join(__dirname, '../../Governance/timeline-remediation/reports');
...
async function main() {
    ...
    const gitUntracked = spawnSync('git', ['ls-files', '--others', '--exclude-standard', '--', 'OSE-backend', 'OSE-Frontend', 'Governance'], { cwd: repoRoot, encoding: 'utf8' });
